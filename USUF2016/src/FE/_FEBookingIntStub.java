 ...
 */
public class _FEBookingIntStub extends org.omg.CORBA.portable.ObjectImpl
        implements FEBookingInt
{
    ...
    private final static Class _opsClass = FE.FEBookingIntOperations.class;
    ...
    public String bookFlight(String firstName, String lastName, String address, String phone, String destination, String date, String classFlight)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if (_so == null)
                   continue;
                FE.FEBookingIntOperations _self = (FE.FEBookingIntOperations) _so.servant;
                try
                {
