 ...
 */
public abstract class FEBookingIntPOA extends org.omg.PortableServer.Servant
        implements FEBookingIntOperations, org.omg.CORBA.portable.InvokeHandler
{
    public FEBookingInt _this()
    {
        return FEBookingIntHelper.narrow(_this_object());
    }

    public FEBookingInt _this(org.omg.CORBA.ORB orb)
    {
        return FEBookingIntHelper.narrow(_this_object(orb));
    }

    private static String [] _ids_list =
    {
        "IDL:FE/FEBookingInt:1.0"
    };
