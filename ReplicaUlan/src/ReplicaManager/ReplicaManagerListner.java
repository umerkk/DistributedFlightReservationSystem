	...
	public void run() {
		try {
			...
			while (continueUDP) {
				...
				msg = machineName.toString() + " recevied for getOpernation: "+udpMessage.getOpernation().toString()+", Sender : "+udpMessage.getSender().toString();
				System.out.println(msg);
				...
				case FrontEnd:
					...
					if (udpMessage.getFrontEndIP().equals(StaticContent.RM1_IP_ADDRESS)
						...
						case softwareFailure:
							msg = machineName.toString()  + "  Inside of  softwareFailure.";
							System.out.println(msg);
							// ifSoftware Failure
							...
							if (softwareFailureCount >= 3) {
								...
								msg = machineName.toString()  + "  restarting the replica.";
						...
						case hardwareFailure:
							...
							softwareFailureCount = 0;
							msg = machineName.toString()  + "  restarting the replica for hardwareFailure.";
							ReplicaManager.ReplicaManagerMain.restartReplica();
							break;
