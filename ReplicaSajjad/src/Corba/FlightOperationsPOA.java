 ...
 */
public abstract class FlightOperationsPOA extends org.omg.PortableServer.Servant
        implements FlightOperationsOperations, org.omg.CORBA.portable.InvokeHandler
{
    public FlightOperations _this()
    {
        return FlightOperationsHelper.narrow(_this_object());
    }

    public FlightOperations _this(org.omg.CORBA.ORB orb)
    {
        return FlightOperationsHelper.narrow(_this_object(orb));
    }

    private static String [] _ids_list =
    {
        "IDL:Corba/FlightOperations:1.0"
    };
