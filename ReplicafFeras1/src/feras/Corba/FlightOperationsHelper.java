...
public class FlightOperationsHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, feras.Corba.FlightOperations t)
    {
     ...
     */
    public static feras.Corba.FlightOperations extract( org.omg.CORBA.Any a )
    {
        ...
        try
        {
            return feras.Corba.FlightOperationsHelper.narrow( a.extract_Object() );
        }
     ...
     */
    public static feras.Corba.FlightOperations read(org.omg.CORBA.portable.InputStream istream)
    {
        return(feras.Corba.FlightOperations)istream.read_Object(feras.Corba._FlightOperationsStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, feras.Corba.FlightOperations value)
    {
